...
class ForesightRecord(DocumentBase, AuditBase):
    ...
    # 时间范围字段
    start_time: Optional[str] = Field(default=None, description="前瞻开始时间（日期字符串，如 2024-01-01）")
    end_time: Optional[str] = Field(default=None, description="前瞻结束时间（日期字符串，如 2024-12-31）")
    ...
    # 向量和模型
    vector: Optional[List[float]] = Field(default=None, description="前瞻的文本向量")
